...
{
    public partial class FrmChiNhapXe : DevComponents.DotNetBar.OfficeForm
    {
        public FrmChiNhapXe()
        {
            InitializeComponent();
        ...
        private void FrmChiNhapXe_Load(object sender, EventArgs e)
        {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "Update HoaDonNhapXe set TienDaTra = @TienDaTra Where IdKey = @idKey And IdCongTy = @IdCongTy";
            cmd.Connection.Open();
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@IdLoaiPhieuChi", 1);
        ...
        private void FrmChiNhapXe_FormClosing(object sender, FormClosingEventArgs e)
        {
