...
{
    public partial class frmPhieuBaoDuongDinhKyVietLong2 : Form
    {
        public string idBaoDuongTamThoi = "";
        public string lichbd = "";

        DataTable datagiamtru = new DataTable();
        public frmPhieuBaoDuongDinhKyVietLong2()
        {
            InitializeComponent();
        ...
        private void FrmPhieuBaoDuongDinhKyVietLong2_Load(object sender, EventArgs e)
        {
